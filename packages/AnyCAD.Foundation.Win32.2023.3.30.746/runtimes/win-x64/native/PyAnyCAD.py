...
def Matrix4_makeRotationAxis(*args):
    return _PyAnyCAD.Matrix4_makeRotationAxis(*args)

def Matrix4_makeScale(x, y, z):
    return _PyAnyCAD.Matrix4_makeScale(x, y, z)

def Matrix4_makeScaleWithCenter(center, scale):
    return _PyAnyCAD.Matrix4_makeScaleWithCenter(center, scale)
...
def ArrayBuffer_GetStaticClassId():
    return _PyAnyCAD.ArrayBuffer_GetStaticClassId()

def ArrayBuffer_Cast(obj):
    return _PyAnyCAD.ArrayBuffer_Cast(obj)
...
def Float32Buffer_GetStaticClassId():
    return _PyAnyCAD.Float32Buffer_GetStaticClassId()

def Float32Buffer_Cast(obj):
    return _PyAnyCAD.Float32Buffer_Cast(obj)

def Float32Buffer_Create(data):
    return _PyAnyCAD.Float32Buffer_Create(data)
...
def Uint32Buffer_GetStaticClassId():
    return _PyAnyCAD.Uint32Buffer_GetStaticClassId()

def Uint32Buffer_Cast(obj):
    return _PyAnyCAD.Uint32Buffer_Cast(obj)

def Uint32Buffer_Create(data):
    return _PyAnyCAD.Uint32Buffer_Create(data)
...
def Uint16Buffer_GetStaticClassId():
    return _PyAnyCAD.Uint16Buffer_GetStaticClassId()

def Uint16Buffer_Cast(obj):
    return _PyAnyCAD.Uint16Buffer_Cast(obj)

def Uint16Buffer_Create(data):
    return _PyAnyCAD.Uint16Buffer_Create(data)
...
def Uint8Buffer_GetStaticClassId():
    return _PyAnyCAD.Uint8Buffer_GetStaticClassId()

def Uint8Buffer_Cast(obj):
    return _PyAnyCAD.Uint8Buffer_Cast(obj)
...
def Int32Buffer_GetStaticClassId():
    return _PyAnyCAD.Int32Buffer_GetStaticClassId()

def Int32Buffer_Cast(obj):
    return _PyAnyCAD.Int32Buffer_Cast(obj)
...
def CharBuffer_GetStaticClassId():
    return _PyAnyCAD.CharBuffer_GetStaticClassId()

def CharBuffer_Cast(obj):
    return _PyAnyCAD.CharBuffer_Cast(obj)
...
def RawBuffer_GetStaticClassId():
    return _PyAnyCAD.RawBuffer_GetStaticClassId()

def RawBuffer_Cast(obj):
    return _PyAnyCAD.RawBuffer_Cast(obj)
...
def DialogUtil_OpenFileDialog(title, filter):
    return _PyAnyCAD.DialogUtil_OpenFileDialog(title, filter)

def DialogUtil_SaveFileDialog(title, fileName, filter):
    return _PyAnyCAD.DialogUtil_SaveFileDialog(title, fileName, filter)

def DialogUtil_NotifyMessage(title, content):
    return _PyAnyCAD.DialogUtil_NotifyMessage(title, content)

def DialogUtil_ShowMessageBox(title, content):
    return _PyAnyCAD.DialogUtil_ShowMessageBox(title, content)
...
class RawShader(object):
    ...
    def SetUniform(self, *args):
        return _PyAnyCAD.RawShader_SetUniform(self, *args)
...
class Texture(GfxObject):
    ...
    def SetUniform(self, *args):
        return _PyAnyCAD.Texture_SetUniform(self, *args)
...
class MaterialInstance(GfxObject):
    ...
    def SetUniform(self, *args):
        return _PyAnyCAD.MaterialInstance_SetUniform(self, *args)
...
def GeometryBuilder_CreatePoints(positions, color3, normals):
    return _PyAnyCAD.GeometryBuilder_CreatePoints(positions, color3, normals)
...
def GeometryBuilder_CreateArc(center, start, end, offset):
    return _PyAnyCAD.GeometryBuilder_CreateArc(center, start, end, offset)

def GeometryBuilder_CreateArrowHead():
    return _PyAnyCAD.GeometryBuilder_CreateArrowHead()

def GeometryBuilder_UpdatePoint(geometry, pt):
    return _PyAnyCAD.GeometryBuilder_UpdatePoint(geometry, pt)
...
def GeometryBuilder_AtomLine():
    return _PyAnyCAD.GeometryBuilder_AtomLine()

def GeometryBuilder_AtomRectangle():
    return _PyAnyCAD.GeometryBuilder_AtomRectangle()

def GeometryBuilder_UnitArrowTemplate():
    return _PyAnyCAD.GeometryBuilder_UnitArrowTemplate()

def GeometryBuilder_AtomPointShape():
    return _PyAnyCAD.GeometryBuilder_AtomPointShape()
...
class SceneNode(GfxObject):
    ...
    def SetChildrenPickable(self, val):
        return _PyAnyCAD.SceneNode_SetChildrenPickable(self, val)
    ...
    def UpdateWorldTransform(self, scene):
        return _PyAnyCAD.SceneNode_UpdateWorldTransform(self, scene)
...
class PickedItem(object):
    ...
    def GetObjectId(self):
        return _PyAnyCAD.PickedItem_GetObjectId(self)

    def SetObjectId(self, val):
        return _PyAnyCAD.PickedItem_SetObjectId(self, val)
...
def ParticleSceneNode_Cast(obj):
    return _PyAnyCAD.ParticleSceneNode_Cast(obj)
...
def SegmentsSceneNode_Cast(obj):
    return _PyAnyCAD.SegmentsSceneNode_Cast(obj)
...
class CoordinateWidget(GeneralSceneNode):
    ...
    @staticmethod
    def Cast(obj):
        return _PyAnyCAD.CoordinateWidget_Cast(obj)
...
def AxisWidget_Cast(obj):
    return _PyAnyCAD.AxisWidget_Cast(obj)

def AxisWidget_Create(radius, length):
    return _PyAnyCAD.AxisWidget_Create(radius, length)

class AxWidget(CoordinateWidget):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    ...
    @staticmethod
    def Create(length, lineWidth):
        return _PyAnyCAD.AxWidget_Create(length, lineWidth)
...
def AxWidget_Cast(obj):
    return _PyAnyCAD.AxWidget_Cast(obj)

def AxWidget_Create(length, lineWidth):
    return _PyAnyCAD.AxWidget_Create(length, lineWidth)
...
def CoordinateGridWidget_Cast(obj):
    return _PyAnyCAD.CoordinateGridWidget_Cast(obj)
...
def LineCoordinateWidget_Cast(obj):
    return _PyAnyCAD.LineCoordinateWidget_Cast(obj)
...
class PickedItemSet(object):
    ...
    def GetObjectIds(self):
        return _PyAnyCAD.PickedItemSet_GetObjectIds(self)
...
class PickCaster(object):
    ...
    def __init__(self, camera, pickFilter):
        _PyAnyCAD.PickCaster_swiginit(self, _PyAnyCAD.new_PickCaster(camera, pickFilter))
...
def AlignedDimensionNode_Cast(obj):
    return _PyAnyCAD.AlignedDimensionNode_Cast(obj)
...
def LinearDimensionNode_Cast(obj):
    return _PyAnyCAD.LinearDimensionNode_Cast(obj)

def LinearDimensionNode_Create(start, end, location, angle, text):
    return _PyAnyCAD.LinearDimensionNode_Create(start, end, location, angle, text)
...
def AngularDimensionNode_Cast(obj):
    return _PyAnyCAD.AngularDimensionNode_Cast(obj)
...
def MeasureDistanceNode_Cast(obj):
    return _PyAnyCAD.MeasureDistanceNode_Cast(obj)
...
def RadiusDimensionNode_Cast(obj):
    return _PyAnyCAD.RadiusDimensionNode_Cast(obj)

def RadiusDimensionNode_Create(center, startPoint, endPoint, text):
    return _PyAnyCAD.RadiusDimensionNode_Create(center, startPoint, endPoint, text)
...
def MeshTool_ComputeSection(*args):
    return _PyAnyCAD.MeshTool_ComputeSection(*args)

def MeshTool_CreateWireframe(mesh):
    return _PyAnyCAD.MeshTool_CreateWireframe(mesh)
...
class PointCloud(ShapeSceneNode):
    ...
    def __init__(self, shape, pointSize):
        _PyAnyCAD.PointCloud_swiginit(self, _PyAnyCAD.new_PointCloud(shape, pointSize))
    ...
    def SetPosition(self, *args):
        return _PyAnyCAD.PointCloud_SetPosition(self, *args)

    def GetPosition(self, *args):
        return _PyAnyCAD.PointCloud_GetPosition(self, *args)
...
def PointCloud_Cast(obj):
    return _PyAnyCAD.PointCloud_Cast(obj)

def PointCloud_Create(points, colors, normals, pointSize):
    return _PyAnyCAD.PointCloud_Create(points, colors, normals, pointSize)
...
class SharedPointCloud(PointCloud):
    ...
    def __init__(self, shape, pointSize):
        _PyAnyCAD.SharedPointCloud_swiginit(self, _PyAnyCAD.new_SharedPointCloud(shape, pointSize))
...
def SharedPointCloud_Cast(obj):
    return _PyAnyCAD.SharedPointCloud_Cast(obj)

def SharedPointCloud_Create(shmName, bufferSize):
    return _PyAnyCAD.SharedPointCloud_Create(shmName, bufferSize)
...
def SharedShapeNode_Cast(obj):
    return _PyAnyCAD.SharedShapeNode_Cast(obj)

def SharedShapeNode_Create(shmName, bufferSize):
    return _PyAnyCAD.SharedShapeNode_Create(shmName, bufferSize)
...
EnumDHComputeMethod_Crazy_DH = _PyAnyCAD.EnumDHComputeMethod_Crazy_DH
...
class RobotLink(object):
    ...
    def GetUseDH(self):
        return _PyAnyCAD.RobotLink_GetUseDH(self)

    def SetUseDH(self, val):
        return _PyAnyCAD.RobotLink_SetUseDH(self, val)
...
class RobotArm(GroupSceneNode):
    ...
    def GetToolCount(self):
        return _PyAnyCAD.RobotArm_GetToolCount(self)

    def SetToolCount(self, val):
        return _PyAnyCAD.RobotArm_SetToolCount(self, val)

    def GetComputeMethod(self):
        return _PyAnyCAD.RobotArm_GetComputeMethod(self)

    def SetComputeMethod(self, val):
        return _PyAnyCAD.RobotArm_SetComputeMethod(self, val)

    def AddJoint(self, jointType, alpha, a, d, theta):
        return _PyAnyCAD.RobotArm_AddJoint(self, jointType, alpha, a, d, theta)
    ...
    def AddTool(self, alpha, a, d, theta, tool):
        return _PyAnyCAD.RobotArm_AddTool(self, alpha, a, d, theta, tool)

    def ApplyDH(self):
        return _PyAnyCAD.RobotArm_ApplyDH(self)
...
def MathUtil_To(*args):
    return _PyAnyCAD.MathUtil_To(*args)

def MathUtil_Copy(*args):
    return _PyAnyCAD.MathUtil_Copy(*args)
...
def TopoShape_GetStaticClassId():
    return _PyAnyCAD.TopoShape_GetStaticClassId()

def TopoShape_Cast(obj):
    return _PyAnyCAD.TopoShape_Cast(obj)
...
def TopoExplor_GetParentShapes(*args):
    return _PyAnyCAD.TopoExplor_GetParentShapes(*args)
...
def FaceIntersector_Instersect(face, edge):
    return _PyAnyCAD.FaceIntersector_Instersect(face, edge)
...
def ShapeBuilder_MakeHalfSpace(*args):
    return _PyAnyCAD.ShapeBuilder_MakeHalfSpace(*args)
...
class SketchBuilder(object):
    ...
    def MakeRectangleByCenter(center, len, width, radius, bFilled):
        return _PyAnyCAD.SketchBuilder_MakeRectangleByCenter(center, len, width, radius, bFilled)
    ...
    def MakeBezierCurve(*args):
        return _PyAnyCAD.SketchBuilder_MakeBezierCurve(*args)
    ...
    def ConnectEdgesToWires(*args):
        return _PyAnyCAD.SketchBuilder_ConnectEdgesToWires(*args)

    @staticmethod
    def MakeClosedWire(wire, fixGap):
        return _PyAnyCAD.SketchBuilder_MakeClosedWire(wire, fixGap)

    @staticmethod
    def MakeWires(geometry, tol):
        return _PyAnyCAD.SketchBuilder_MakeWires(geometry, tol)
    ...
    def MakeWindingCurve(sketchWire, surface):
        return _PyAnyCAD.SketchBuilder_MakeWindingCurve(sketchWire, surface)
    ...
    def MakeTangentLine(*args):
        return _PyAnyCAD.SketchBuilder_MakeTangentLine(*args)

    @staticmethod
    def ComputePlaneDirection(curve):
        return _PyAnyCAD.SketchBuilder_ComputePlaneDirection(curve)
...
def SketchBuilder_MakeRectangleByCenter(center, len, width, radius, bFilled):
    return _PyAnyCAD.SketchBuilder_MakeRectangleByCenter(center, len, width, radius, bFilled)
...
def SketchBuilder_MakeBezierCurve(*args):
    return _PyAnyCAD.SketchBuilder_MakeBezierCurve(*args)
...
def SketchBuilder_ConnectEdgesToWires(*args):
    return _PyAnyCAD.SketchBuilder_ConnectEdgesToWires(*args)

def SketchBuilder_MakeClosedWire(wire, fixGap):
    return _PyAnyCAD.SketchBuilder_MakeClosedWire(wire, fixGap)

def SketchBuilder_MakeWires(geometry, tol):
    return _PyAnyCAD.SketchBuilder_MakeWires(geometry, tol)
...
def SketchBuilder_MakeWindingCurve(sketchWire, surface):
    return _PyAnyCAD.SketchBuilder_MakeWindingCurve(sketchWire, surface)

def SketchBuilder_MakeCurve(curve, startU, lastU):
    return _PyAnyCAD.SketchBuilder_MakeCurve(curve, startU, lastU)

def SketchBuilder_MakeTangentLine(*args):
    return _PyAnyCAD.SketchBuilder_MakeTangentLine(*args)

def SketchBuilder_ComputePlaneDirection(curve):
    return _PyAnyCAD.SketchBuilder_ComputePlaneDirection(curve)
...
def FeatureTool_Revolve(base, ax, angle):
    return _PyAnyCAD.FeatureTool_Revolve(base, ax, angle)
...
def FeatureTool_CeneterLine(face):
    return _PyAnyCAD.FeatureTool_CeneterLine(face)

def FeatureTool_ExtractCircle(shape):
    return _PyAnyCAD.FeatureTool_ExtractCircle(shape)

def FeatureTool_Evolved(section, spine, joinType, bSolid):
    return _PyAnyCAD.FeatureTool_Evolved(section, spine, joinType, bSolid)
...
def BooleanTool_Boolean(shapeA, shapeB, type):
    return _PyAnyCAD.BooleanTool_Boolean(shapeA, shapeB, type)

def BooleanTool_Cut(*args):
    return _PyAnyCAD.BooleanTool_Cut(*args)
...
def BooleanTool_Section(*args):
    return _PyAnyCAD.BooleanTool_Section(*args)

def BooleanTool_Slice(solid, position, dir, tol):
    return _PyAnyCAD.BooleanTool_Slice(solid, position, dir, tol)

def BooleanTool_Unify(shape, unifyEdges, unifyFaces, concatBSplines):
    return _PyAnyCAD.BooleanTool_Unify(shape, unifyEdges, unifyFaces, concatBSplines)
...
def TransformTool_Copy(shape):
    return _PyAnyCAD.TransformTool_Copy(shape)

def TransformTool_Transform(*args):
    return _PyAnyCAD.TransformTool_Transform(*args)

def TransformTool_TransformByMatrix(pShape, matrix):
    return _PyAnyCAD.TransformTool_TransformByMatrix(pShape, matrix)

def TransformTool_ToMatrix4(*args):
    return _PyAnyCAD.TransformTool_ToMatrix4(*args)
...
class SurfaceBuilder(object):
    ...
    @staticmethod
    def Loft(profiles, guides, spatialTol):
        return _PyAnyCAD.SurfaceBuilder_Loft(profiles, guides, spatialTol)
...
def SurfaceBuilder_Loft(profiles, guides, spatialTol):
    return _PyAnyCAD.SurfaceBuilder_Loft(profiles, guides, spatialTol)
...
class Sketch2dBuilder(object):
    ...
    def MakeArcByLines(line1, line2, radius, tol, keepMinor):
        return _PyAnyCAD.Sketch2dBuilder_MakeArcByLines(line1, line2, radius, tol, keepMinor)
    ...
    def MakePolygon(center, dirx, radius, cornerCount):
        return _PyAnyCAD.Sketch2dBuilder_MakePolygon(center, dirx, radius, cornerCount)

    @staticmethod
    def MakeArc(*args):
        return _PyAnyCAD.Sketch2dBuilder_MakeArc(*args)

    @staticmethod
    def MakeArcBy3Points(start, end, middle):
        return _PyAnyCAD.Sketch2dBuilder_MakeArcBy3Points(start, end, middle)
    ...
    def To3D(curve, plane):
        return _PyAnyCAD.Sketch2dBuilder_To3D(curve, plane)
...
def Sketch2dBuilder_MakeArcByLines(line1, line2, radius, tol, keepMinor):
    return _PyAnyCAD.Sketch2dBuilder_MakeArcByLines(line1, line2, radius, tol, keepMinor)

def Sketch2dBuilder_MakeCircle(cirlce):
    return _PyAnyCAD.Sketch2dBuilder_MakeCircle(cirlce)

def Sketch2dBuilder_MakePolygon(center, dirx, radius, cornerCount):
    return _PyAnyCAD.Sketch2dBuilder_MakePolygon(center, dirx, radius, cornerCount)

def Sketch2dBuilder_MakeArc(*args):
    return _PyAnyCAD.Sketch2dBuilder_MakeArc(*args)

def Sketch2dBuilder_MakeArcBy3Points(start, end, middle):
    return _PyAnyCAD.Sketch2dBuilder_MakeArcBy3Points(start, end, middle)
...
def Sketch2dBuilder_To3D(curve, plane):
    return _PyAnyCAD.Sketch2dBuilder_To3D(curve, plane)
...
class BufferShapeBase(object):
    ...
    def SetDeflection(self, val):
        return _PyAnyCAD.BufferShapeBase_SetDeflection(self, val)
    ...
    def GetDisplayFilter(self):
        return _PyAnyCAD.BufferShapeBase_GetDisplayFilter(self)

    def SetDisplayFilter(self, val):
        return _PyAnyCAD.BufferShapeBase_SetDisplayFilter(self, val)
...
def ShapeIO_Open(*args):
    return _PyAnyCAD.ShapeIO_Open(*args)

def ShapeIO_Save(*args):
    return _PyAnyCAD.ShapeIO_Save(*args)
...
def RegisterDataKernelModule():
    return _PyAnyCAD.RegisterDataKernelModule()
...
def ParameterObjectId_GetStaticClassId():
    return _PyAnyCAD.ParameterObjectId_GetStaticClassId()

def ParameterObjectId_Cast(obj):
    return _PyAnyCAD.ParameterObjectId_Cast(obj)
...
def ParameterGPnt2d_GetStaticClassId():
    return _PyAnyCAD.ParameterGPnt2d_GetStaticClassId()

def ParameterGPnt2d_Cast(obj):
    return _PyAnyCAD.ParameterGPnt2d_Cast(obj)
...
def ParameterGVec2d_GetStaticClassId():
    return _PyAnyCAD.ParameterGVec2d_GetStaticClassId()

def ParameterGVec2d_Cast(obj):
    return _PyAnyCAD.ParameterGVec2d_Cast(obj)
...
def ParameterGDir2d_GetStaticClassId():
    return _PyAnyCAD.ParameterGDir2d_GetStaticClassId()

def ParameterGDir2d_Cast(obj):
    return _PyAnyCAD.ParameterGDir2d_Cast(obj)
...
class ElementTable(object):
    ...
    def FindComponent(self, entityId):
        return _PyAnyCAD.ElementTable_FindComponent(self, entityId)
...
class Document(AObject):
    ...
    def SetActiveSketchId(self, id):
        return _PyAnyCAD.Document_SetActiveSketchId(self, id)
...
class DocumentListener(object):
    ...
    def OnSwitchSketch(self, pDocument):
        return _PyAnyCAD.DocumentListener_OnSwitchSketch(self, pDocument)
    def __disown__(self):
        self.this.disown()
...
class DocumentEvent(object):
    ...
    def NotifyDocumentCreated(self, pDocument):
        return _PyAnyCAD.DocumentEvent_NotifyDocumentCreated(self, pDocument)

    def NotifySwitchSketch(self, pDocument):
        return _PyAnyCAD.DocumentEvent_NotifySwitchSketch(self, pDocument)
...
def Component_GetStaticClassId():
    return _PyAnyCAD.Component_GetStaticClassId()

def Component_Cast(obj):
    return _PyAnyCAD.Component_Cast(obj)
...
class EntityElement(Element):
    ...
    def GetComponent(self, name):
        return _PyAnyCAD.EntityElement_GetComponent(self, name)

# Register EntityElement in _PyAnyCAD:
_PyAnyCAD.EntityElement_swigregister(EntityElement)

def EntityElement_GetStaticClassId():
    return _PyAnyCAD.EntityElement_GetStaticClassId()

def EntityElement_Cast(obj):
    return _PyAnyCAD.EntityElement_Cast(obj)

def EntityElement_Create(pDoc):
    return _PyAnyCAD.EntityElement_Create(pDoc)
...
class PropertyComponent(Component):
    ...
    @staticmethod
    def GetStaticClassId():
        return _PyAnyCAD.PropertyComponent_GetStaticClassId()

    def GetClassId(self):
        return _PyAnyCAD.PropertyComponent_GetClassId(self)

    @staticmethod
    def Cast(obj):
        return _PyAnyCAD.PropertyComponent_Cast(obj)

    @staticmethod
    def Create(pDoc, entityId):
        return _PyAnyCAD.PropertyComponent_Create(pDoc, entityId)

    def __init__(self, *args):
        _PyAnyCAD.PropertyComponent_swiginit(self, _PyAnyCAD.new_PropertyComponent(*args))
    __swig_destroy__ = _PyAnyCAD.delete_PropertyComponent

    def GetParameterDict(self):
        return _PyAnyCAD.PropertyComponent_GetParameterDict(self)

    def CreateParameterIterator(self):
        return _PyAnyCAD.PropertyComponent_CreateParameterIterator(self)

    def RemoveParameter(self, name):
        return _PyAnyCAD.PropertyComponent_RemoveParameter(self, name)

    def FindParameter(self, name):
        return _PyAnyCAD.PropertyComponent_FindParameter(self, name)

    def SetParameter(self, *args):
        return _PyAnyCAD.PropertyComponent_SetParameter(self, *args)

# Register PropertyComponent in _PyAnyCAD:
_PyAnyCAD.PropertyComponent_swigregister(PropertyComponent)

def PropertyComponent_GetStaticClassId():
    return _PyAnyCAD.PropertyComponent_GetStaticClassId()

def PropertyComponent_Cast(obj):
    return _PyAnyCAD.PropertyComponent_Cast(obj)

def PropertyComponent_Create(pDoc, entityId):
    return _PyAnyCAD.PropertyComponent_Create(pDoc, entityId)
...
def StreamComponent_GetStaticClassId():
    return _PyAnyCAD.StreamComponent_GetStaticClassId()

def StreamComponent_Cast(obj):
    return _PyAnyCAD.StreamComponent_Cast(obj)

def StreamComponent_Create(pDoc, entityId):
    return _PyAnyCAD.StreamComponent_Create(pDoc, entityId)
...
class TransformComponent(Component):
    ...
    def GetWorldBBox(self):
        return _PyAnyCAD.TransformComponent_GetWorldBBox(self)
...
def TransformComponent_GetStaticClassId():
    return _PyAnyCAD.TransformComponent_GetStaticClassId()

def TransformComponent_Cast(obj):
    return _PyAnyCAD.TransformComponent_Cast(obj)

def TransformComponent_Create(pDoc, entityId):
    return _PyAnyCAD.TransformComponent_Create(pDoc, entityId)
...
class DrawableElement(EntityElement):
    ...
    def GetMaterialId(self):
        return _PyAnyCAD.DrawableElement_GetMaterialId(self)

    def SetMaterialId(self, val):
        return _PyAnyCAD.DrawableElement_SetMaterialId(self, val)
    ...
    def GetFinalShape(self):
        return _PyAnyCAD.DrawableElement_GetFinalShape(self)
...
def DrawableElement_Create(pDoc):
    return _PyAnyCAD.DrawableElement_Create(pDoc)

class GroupDrawable(DrawableElement):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    @staticmethod
    def GetStaticClassId():
        return _PyAnyCAD.GroupDrawable_GetStaticClassId()

    def GetClassId(self):
        return _PyAnyCAD.GroupDrawable_GetClassId(self)

    @staticmethod
    def Cast(obj):
        return _PyAnyCAD.GroupDrawable_Cast(obj)

    @staticmethod
    def Create(pDoc):
        return _PyAnyCAD.GroupDrawable_Create(pDoc)

    def __init__(self):
        _PyAnyCAD.GroupDrawable_swiginit(self, _PyAnyCAD.new_GroupDrawable())
    __swig_destroy__ = _PyAnyCAD.delete_GroupDrawable

    def GetChildren(self):
        return _PyAnyCAD.GroupDrawable_GetChildren(self)

    def SetChildren(self, val):
        return _PyAnyCAD.GroupDrawable_SetChildren(self, val)

    def AddChild(self, id):
        return _PyAnyCAD.GroupDrawable_AddChild(self, id)

    def RemoveChild(self, id):
        return _PyAnyCAD.GroupDrawable_RemoveChild(self, id)

    def UpdateTransform(self):
        return _PyAnyCAD.GroupDrawable_UpdateTransform(self)

# Register GroupDrawable in _PyAnyCAD:
_PyAnyCAD.GroupDrawable_swigregister(GroupDrawable)

def GroupDrawable_GetStaticClassId():
    return _PyAnyCAD.GroupDrawable_GetStaticClassId()

def GroupDrawable_Cast(obj):
    return _PyAnyCAD.GroupDrawable_Cast(obj)

def GroupDrawable_Create(pDoc):
    return _PyAnyCAD.GroupDrawable_Create(pDoc)
...
def GroupElement_GetStaticClassId():
    return _PyAnyCAD.GroupElement_GetStaticClassId()

def GroupElement_Cast(obj):
    return _PyAnyCAD.GroupElement_Cast(obj)

def GroupElement_Create(pDoc):
    return _PyAnyCAD.GroupElement_Create(pDoc)

def GroupElement_FindGroup(doc, id):
    return _PyAnyCAD.GroupElement_FindGroup(doc, id)
...
class DrawableInstance(DrawableElement):
    ...
    @staticmethod
    def Create(pDoc):
        return _PyAnyCAD.DrawableInstance_Create(pDoc)
    ...
    def GetPrototypeId(self):
        return _PyAnyCAD.DrawableInstance_GetPrototypeId(self)

    def SetPrototypeId(self, val):
        return _PyAnyCAD.DrawableInstance_SetPrototypeId(self, val)
...
def DrawableInstance_Create(pDoc):
    return _PyAnyCAD.DrawableInstance_Create(pDoc)
...
class ShapeElement(DrawableElement):
    ...
    def SetFaceColor(self, faceId, color):
        return _PyAnyCAD.ShapeElement_SetFaceColor(self, faceId, color)
...
def MaterialElement_Create(pDoc):
    return _PyAnyCAD.MaterialElement_Create(pDoc)
...
class VisualElement(DrawableElement):
    ...
    def SetPrimitive(self, val):
        return _PyAnyCAD.VisualElement_SetPrimitive(self, val)

    def GetCompound(self):
        return _PyAnyCAD.VisualElement_GetCompound(self)

    def SetCompound(self, val):
        return _PyAnyCAD.VisualElement_SetCompound(self, val)

    def UpdateTransform(self):
        return _PyAnyCAD.VisualElement_UpdateTransform(self)

    def UpdateMaterial(self):
        return _PyAnyCAD.VisualElement_UpdateMaterial(self)

# Register VisualElement in _PyAnyCAD:
_PyAnyCAD.VisualElement_swigregister(VisualElement)

def VisualElement_GetStaticClassId():
    return _PyAnyCAD.VisualElement_GetStaticClassId()

def VisualElement_Cast(obj):
    return _PyAnyCAD.VisualElement_Cast(obj)

def VisualElement_Create(pDoc):
    return _PyAnyCAD.VisualElement_Create(pDoc)

def VisualElement_InitRx():
    return _PyAnyCAD.VisualElement_InitRx()
...
class PointElement(DrawableElement):
    ...
    def SetValue(self, val):
        return _PyAnyCAD.PointElement_SetValue(self, val)

    def GetPrimitive(self):
        return _PyAnyCAD.PointElement_GetPrimitive(self)

    def SetPrimitive(self, val):
        return _PyAnyCAD.PointElement_SetPrimitive(self, val)

# Register PointElement in _PyAnyCAD:
_PyAnyCAD.PointElement_swigregister(PointElement)

def PointElement_GetStaticClassId():
    return _PyAnyCAD.PointElement_GetStaticClassId()

def PointElement_Cast(obj):
    return _PyAnyCAD.PointElement_Cast(obj)

def PointElement_Create(pDoc):
    return _PyAnyCAD.PointElement_Create(pDoc)
...
def CoordinateSystemElement_GetStaticClassId():
    return _PyAnyCAD.CoordinateSystemElement_GetStaticClassId()

def CoordinateSystemElement_Cast(obj):
    return _PyAnyCAD.CoordinateSystemElement_Cast(obj)

def CoordinateSystemElement_Create(pDoc):
    return _PyAnyCAD.CoordinateSystemElement_Create(pDoc)
...
def ConstraintElement_GetStaticClassId():
    return _PyAnyCAD.ConstraintElement_GetStaticClassId()

def ConstraintElement_Cast(obj):
    return _PyAnyCAD.ConstraintElement_Cast(obj)

def ConstraintElement_Create(pDoc):
    return _PyAnyCAD.ConstraintElement_Create(pDoc)
...
def CoordinateConstraint_GetStaticClassId():
    return _PyAnyCAD.CoordinateConstraint_GetStaticClassId()

def CoordinateConstraint_Cast(obj):
    return _PyAnyCAD.CoordinateConstraint_Cast(obj)

def CoordinateConstraint_Create(pDoc):
    return _PyAnyCAD.CoordinateConstraint_Create(pDoc)
...
class ElementSchema(object):
    ...
    def OnParameterChanged(self, document, properties):
        return _PyAnyCAD.ElementSchema_OnParameterChanged(self, document, properties)
...
def RegisterDataSketchModule():
    return _PyAnyCAD.RegisterDataSketchModule()
...
class SketchCurve(DrawableElement):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def GetSketchId(self):
        return _PyAnyCAD.SketchCurve_GetSketchId(self)

    def SetSketchId(self, val):
        return _PyAnyCAD.SketchCurve_SetSketchId(self, val)
...
def SketchCurve_GetStaticClassId():
    return _PyAnyCAD.SketchCurve_GetStaticClassId()

def SketchCurve_Cast(obj):
    return _PyAnyCAD.SketchCurve_Cast(obj)

def SketchCurve_Create(pDoc):
    return _PyAnyCAD.SketchCurve_Create(pDoc)

class SketchPlane(DrawableElement):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def GetShape(self):
        return _PyAnyCAD.SketchPlane_GetShape(self)

    def SetShape(self, val):
        return _PyAnyCAD.SketchPlane_SetShape(self, val)
    ...
    def AddConstraint(self, type, srcId, srcPId, targetId, targetPid, val):
        return _PyAnyCAD.SketchPlane_AddConstraint(self, type, srcId, srcPId, targetId, targetPid, val)
...
def SketchPlane_GetStaticClassId():
    return _PyAnyCAD.SketchPlane_GetStaticClassId()

def SketchPlane_Cast(obj):
    return _PyAnyCAD.SketchPlane_Cast(obj)

def SketchPlane_Create(pDoc):
    return _PyAnyCAD.SketchPlane_Create(pDoc)
...
def FeatureElement_GetStaticClassId():
    return _PyAnyCAD.FeatureElement_GetStaticClassId()

def FeatureElement_Cast(obj):
    return _PyAnyCAD.FeatureElement_Cast(obj)

def FeatureElement_Create(pDoc):
    return _PyAnyCAD.FeatureElement_Create(pDoc)
...
def CraftPathFeature_GetStaticClassId():
    return _PyAnyCAD.CraftPathFeature_GetStaticClassId()

def CraftPathFeature_Cast(obj):
    return _PyAnyCAD.CraftPathFeature_Cast(obj)

def CraftPathFeature_Create(pDoc):
    return _PyAnyCAD.CraftPathFeature_Create(pDoc)
...
def PlaneCutFeature_GetStaticClassId():
    return _PyAnyCAD.PlaneCutFeature_GetStaticClassId()

def PlaneCutFeature_Cast(obj):
    return _PyAnyCAD.PlaneCutFeature_Cast(obj)

def PlaneCutFeature_Create(pDoc):
    return _PyAnyCAD.PlaneCutFeature_Create(pDoc)
...
class DocumentIO(object):
    ...
    def __init__(self):
        _PyAnyCAD.DocumentIO_swiginit(self, _PyAnyCAD.new_DocumentIO())
...
def RegisterDataMeshModule():
    return _PyAnyCAD.RegisterDataMeshModule()
...
def PointCloudElement_GetStaticClassId():
    return _PyAnyCAD.PointCloudElement_GetStaticClassId()

def PointCloudElement_Cast(obj):
    return _PyAnyCAD.PointCloudElement_Cast(obj)

def PointCloudElement_Create(pDoc):
    return _PyAnyCAD.PointCloudElement_Create(pDoc)


def RegisterGraphicsViewModule():
    return _PyAnyCAD.RegisterGraphicsViewModule()
...
class EditorListener(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        if self.__class__ == EditorListener:
            _self = None
        else:
            _self = self
        _PyAnyCAD.EditorListener_swiginit(self, _PyAnyCAD.new_EditorListener(_self, ))
    __swig_destroy__ = _PyAnyCAD.delete_EditorListener

    def OnStartEditor(self, name, ctx):
        return _PyAnyCAD.EditorListener_OnStartEditor(self, name, ctx)

    def OnFinishEditor(self, name, ctx):
        return _PyAnyCAD.EditorListener_OnFinishEditor(self, name, ctx)

    def OnChanging(self, name, ctx, pNode, ids):
        return _PyAnyCAD.EditorListener_OnChanging(self, name, ctx, pNode, ids)

    def OnChanged(self, name, ctx, pNode, ids):
        return _PyAnyCAD.EditorListener_OnChanged(self, name, ctx, pNode, ids)

    def BeforeRendering(self, name, ctx):
        return _PyAnyCAD.EditorListener_BeforeRendering(self, name, ctx)

    def AfterRendering(self, name, ctx):
        return _PyAnyCAD.EditorListener_AfterRendering(self, name, ctx)
    def __disown__(self):
        self.this.disown()
        _PyAnyCAD.disown_EditorListener(self)
        return weakref.proxy(self)

# Register EditorListener in _PyAnyCAD:
_PyAnyCAD.EditorListener_swigregister(EditorListener)
...
class EditorEvent(object):
    ...
    @staticmethod
    def Instance():
        return _PyAnyCAD.EditorEvent_Instance()
    __swig_destroy__ = _PyAnyCAD.delete_EditorEvent

    def AddListener(self, listener):
        return _PyAnyCAD.EditorEvent_AddListener(self, listener)

    def RemoveListener(self, listener):
        return _PyAnyCAD.EditorEvent_RemoveListener(self, listener)

    def NotifyNodeChanging(self, *args):
        return _PyAnyCAD.EditorEvent_NotifyNodeChanging(self, *args)

    def NotifyNodeChanged(self, *args):
        return _PyAnyCAD.EditorEvent_NotifyNodeChanged(self, *args)

    def NotifyStartEditor(self, name, ctx):
        return _PyAnyCAD.EditorEvent_NotifyStartEditor(self, name, ctx)

    def NotifyFinishEditor(self, name, ctx):
        return _PyAnyCAD.EditorEvent_NotifyFinishEditor(self, name, ctx)

    def NotifyBeforeRendering(self, name, ctx):
        return _PyAnyCAD.EditorEvent_NotifyBeforeRendering(self, name, ctx)

    def NotifyAfterRendering(self, name, ctx):
        return _PyAnyCAD.EditorEvent_NotifyAfterRendering(self, name, ctx)

# Register EditorEvent in _PyAnyCAD:
_PyAnyCAD.EditorEvent_swigregister(EditorEvent)

def EditorEvent_Instance():
    return _PyAnyCAD.EditorEvent_Instance()
...
class Command(object):
    ...
    def RunWithEvent(self, viewer, parameters):
        return _PyAnyCAD.Command_RunWithEvent(self, viewer, parameters)
    def __disown__(self):
        self.this.disown()
...
class RenderingEngine(object):
    ...
    @staticmethod
    def RegiserNETSdk(a, b, d, e):
        return _PyAnyCAD.RenderingEngine_RegiserNETSdk(a, b, d, e)
...
def RenderingEngine_RegiserNETSdk(a, b, d, e):
    return _PyAnyCAD.RenderingEngine_RegiserNETSdk(a, b, d, e)
...
def RegisterDataViewModule():
    return _PyAnyCAD.RegisterDataViewModule()
class Application(object):
    ...
    def Input(self, parameters):
        return _PyAnyCAD.Application_Input(self, parameters)
...
def DocumentSceneNode_Cast(obj):
    return _PyAnyCAD.DocumentSceneNode_Cast(obj)
