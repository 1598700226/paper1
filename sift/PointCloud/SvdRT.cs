...
namespace sift.PointCloud
{
    public class SvdRT
    {
        ...
        {
            // 生成用于运算的点云
            Matrix<double> sourceCloud = GeneratePointCloud(sourceClouds);
            Matrix<double> targetCloud = GeneratePointCloud(targetClouds);
        ...
        private static Matrix<double> GeneratePointCloud(int numPoints)
        {
            Matrix<double> pointCloud = Matrix<double>.Build.Dense(numPoints, 3);
        ...
        private static Matrix<double> GeneratePointCloud(List<PointCloud3D> pointClouds)
        {
        ...
        public static double[,] calNormalVector(List<PointCloud3D> nearPointCloud3Ds, PointCloud3D pointCloud)
        {
            ...
            // 生成用于运算的点云
            Matrix<double> nearPoints = GeneratePointCloud(nearPointCloud3Ds);
